...
function carrinhof(){
  ...
  if(carrinhoa.length == 0){
    let strHTML = `<h2 style="color:#0D8F08;" class="d-flex align-items-center flex-column p-4 text-center"><i class="fa-solid fa-cart-shopping fa-2x mb-4"></i>seu carrinhoa esta vazio</h2>`
